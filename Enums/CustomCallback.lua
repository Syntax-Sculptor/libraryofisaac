...
TSIL.Enums.CustomCallback = {
	...
	POST_ENTITY_TAKE_DMG_FILTER = "POST_ENTITY_TAKE_DMG_FILTER",

	POST_BOMB_COLLISION_FILTER = "POST_BOMB_COLLISION_FILTER",

	PRE_BOMB_RENDER_FILTER = "PRE_BOMB_RENDER_FILTER",

	PRE_EFFECT_RENDER_FILTER = "PRE_EFFECT_RENDER_FILTER",

	POST_FAMILIAR_COLLISION_FILTER = "POST_FAMILIAR_COLLISION_FILTER",

	PRE_FAMILIAR_RENDER_FILTER = "PRE_FAMILIAR_RENDER_FILTER",

	GET_FOLLOWER_PRIORITY_FILTER = "GET_FOLLOWER_PRIORITY_FILTER",

	POST_KNIFE_COLLISION_FILTER = "POST_KNIFE_COLLISION_FILTER",

	PRE_KNIFE_RENDER_FILTER = "PRE_KNIFE_RENDER_FILTER",

	PRE_LASER_COLLISION_FILTER = "PRE_LASER_COLLISION_FILTER",

	POST_LASER_COLLISION_FILTER = "POST_LASER_COLLISION_FILTER",

	POST_NPC_COLLISION_FILTER = "POST_NPC_COLLISION_FILTER",

	PRE_NPC_PICK_TARGET_FILTER = "PRE_NPC_PICK_TARGET_FILTER",

	POST_NPC_DARK_RED_CHAMPION_REGEN_FILTER = "POST_NPC_DARK_RED_CHAMPION_REGEN_FILTER",

	PRE_NPC_RENDER_FILTER = "PRE_NPC_RENDER_FILTER",

	PRE_NPC_SPLIT_FILTER = "PRE_NPC_SPLIT_FILTER",

	POST_PICKUP_COLLISION_FILTER = "POST_PICKUP_COLLISION_FILTER",

	PRE_PICKUP_COMPOSTED_FILTER = "PRE_PICKUP_COMPOSTED_FILTER",

	PRE_PICKUP_RENDER_FILTER = "PRE_PICKUP_RENDER_FILTER",

    POST_PICKUP_SHOP_PURCHASE_FILTER = "POST_PICKUP_SHOP_PURCHASE_FILTER",

    PRE_PICKUP_VOIDED_ABYSS_FILTER = "PRE_PICKUP_VOIDED_ABYSS_FILTER",
	
    PRE_PICKUP_VOIDED_FILTER = "PRE_PICKUP_VOIDED_FILTER",

    PRE_SLOT_COLLISION_FILTER = "PRE_SLOT_COLLISION_FILTER",

    POST_SLOT_COLLISION_FILTER = "POST_SLOT_COLLISION_FILTER",

    PRE_SLOT_CREATE_EXPLOSION_DROPS_FILTER = "PRE_SLOT_CREATE_EXPLOSION_DROPS_FILTER",

    POST_SLOT_CREATE_EXPLOSION_DROPS_FILTER = "POST_SLOT_CREATE_EXPLOSION_DROPS_FILTER",

    POST_SLOT_INIT_FILTER = "POST_SLOT_INIT_FILTER",

    PRE_SLOT_RENDER_FILTER = "PRE_SLOT_RENDER_FILTER",

    POST_SLOT_RENDER_FILTER = "POST_SLOT_RENDER_FILTER",

    PRE_SLOT_SET_PRIZE_COLLECTIBLE_FILTER = "PRE_SLOT_SET_PRIZE_COLLECTIBLE_FILTER",

    POST_SLOT_SET_PRIZE_COLLECTIBLE_FILTER = "POST_SLOT_SET_PRIZE_COLLECTIBLE_FILTER",

    PRE_SLOT_UPDATE_FILTER = "PRE_SLOT_UPDATE_FILTER",

    POST_SLOT_UPDATE_FILTER = "POST_SLOT_UPDATE_FILTER",

    POST_TEAR_COLLISION_FILTER = "POST_TEAR_COLLISION_FILTER",

    PRE_TEAR_RENDER_FILTER = "PRE_TEAR_RENDER_FILTER",

    PRE_TEAR_GRID_COLLISION_FILTER = "PRE_TEAR_GRID_COLLISION_FILTER",

    POST_TEAR_COLLISION_GRID_FILTER = "POST_TEAR_COLLISION_GRID_FILTER",

    PRE_FAMILIAR_GRID_COLLISION_FILTER = "PRE_FAMILIAR_GRID_COLLISION_FILTER",

    POST_FAMILIAR_GRID_COLLISION_FILTER = "POST_FAMILIAR_GRID_COLLISION_FILTER",

    PRE_BOMB_GRID_COLLISION_FILTER = "PRE_BOMB_GRID_COLLISION_FILTER",

    POST_BOMB_GRID_COLLISION_FILTER = "POST_BOMB_GRID_COLLISION_FILTER",

    PRE_PICKUP_GRID_COLLISION_FILTER = "PRE_PICKUP_GRID_COLLISION_FILTER",

    POST_PICKUP_GRID_COLLISION_FILTER = "POST_PICKUP_GRID_COLLISION_FILTER",

    PRE_PROJECTILE_GRID_COLLISION_FILTER = "PRE_PROJECTILE_GRID_COLLISION_FILTER",

    POST_PROJECTILE_GRID_COLLISION_FILTER = "POST_PROJECTILE_GRID_COLLISION_FILTER",

    PRE_NPC_GRID_COLLISION_FILTER = "PRE_NPC_GRID_COLLISION_FILTER",

    POST_NPC_GRID_COLLISION_FILTER = "POST_NPC_GRID_COLLISION_FILTER",

    POST_PROJECTILE_DEATH_FILTER = "POST_PROJECTILE_DEATH_FILTER",

    POST_TEAR_DEATH_FILTER = "POST_TEAR_DEATH_FILTER",

    PRE_TEAR_UPDATE_FILTER = "PRE_TEAR_UPDATE_FILTER",

    PRE_FAMILIAR_UPDATE_FILTER = "PRE_FAMILIAR_UPDATE_FILTER",

    PRE_BOMB_UPDATE_FILTER = "PRE_BOMB_UPDATE_FILTER",

    PRE_PICKUP_UPDATE_FILTER = "PRE_PICKUP_UPDATE_FILTER",

    PRE_KNIFE_UPDATE_FILTER = "PRE_KNIFE_UPDATE_FILTER",

    PRE_PROJECTILE_UPDATE_FILTER = "PRE_PROJECTILE_UPDATE_FILTER",

    PRE_LASER_UPDATE_FILTER = "PRE_LASER_UPDATE_FILTER",

    PRE_EFFECT_UPDATE_FILTER = "PRE_EFFECT_UPDATE_FILTER",
}
